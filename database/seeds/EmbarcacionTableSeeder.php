...
class EmbarcacionTableSeeder extends Seeder
{
    ...
    {
        //
        Embarcacion::insert([  'nombre' => 'Embarcacion 1', 'nMatricula' => 'MATR345FSS', 'armador_id' => 2,
        ...
        Embarcacion::insert([  'nombre' => 'Embarcacion 2', 'nMatricula' => 'MR34YT5FS2', 'armador_id' => 7,
        	'capacidad'=>50,'estara'=>5.2,'manga'=>9.6, 'puntual' =>5.7, 'certificado_matricula_id'=> 2, 'permiso_pesca_id'=>2,
        	'imagen'=>'images/embarcacion.jpg', 'activo' => 1]);
        Embarcacion::insert([  'nombre' => 'Embarcacion 3', 'nMatricula' => 'NDFFATEDS8', 'armador_id' => 8,
        	'capacidad'=>60,'estara'=>8.2,'manga'=>12.6, 'puntual' =>7.2, 'certificado_matricula_id'=> 3, 'permiso_pesca_id'=>3,
        	'imagen'=>'images/embarcacion.jpg', 'activo' => 1]);
        Embarcacion::insert([  'nombre' => 'Embarcacion 4', 'nMatricula' => 'RF562FS345', 'armador_id' => 2,
        	'capacidad'=>70,'estara'=>15.2,'manga'=>7.6, 'puntual' =>4.2, 
        	'imagen'=>'images/embarcacion.jpg', 'activo' => 1]);
        Embarcacion::insert([  'nombre' => 'Embarcacion 5', 'nMatricula' => 'MDR3434DD3', 'armador_id' => 7,
