...
<div class="row">
    ...
    <div class="col-sm-8">
        <table class="table table-bordered table-striped">
          ...
          <tr>
              <th>Fabrica</th>
              <th >{{$certificado->fabrica->id}} {{$certificado->fabrica->nombre}}</th>   
              <th >{{$codFabrica}}</th>
          </tr> 
        </table>
    </div>
...
<br>
  <div class="row">
    <div class="col-sm-12">
      {!!Form::open(array('url' => 'usuarioIntermediario/lotesFabricas/'.$notaIngreso->id.'/'.$certificado->id.'/agregarTrazabilidad','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
        <div class="form-group">
