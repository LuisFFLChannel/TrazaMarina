...
@section('title')
	Nuevo Certificado de Procedencia
@stop
  ...
  <div class="col-sm-10">
    {!!Form::open(array('url' => 'usuarioIntermediario/certificadoProcedencias/new','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                {!! Form::select('empresario_id', $empresarios_lista->toArray(), null, ['class' => 'form-control','required', 'id'=>'empresario_id']) !!}
            </div>
        </div>
        <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-sm-offset-3 col-sm-9">
          ...
          <a href="{{action('CertificadoProcedenciaController@index')}}"><button type="button" class="btn btn-info">Cancelar</button></a>
        </div>
      </div>
