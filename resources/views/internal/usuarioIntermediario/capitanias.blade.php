...
<table class="table table-bordered table-striped">
    ...
    <tr>
      ...
      <td class="text-center">
          <a class="btn btn-info" href="{{url('usuarioIntermediario/mapas/'.$capitania->id.'/mostarMapaCapitania')}}" title="Mostrar Mapa" ><i class="glyphicon glyphicon-map-marker"></i></a>
        </td>
