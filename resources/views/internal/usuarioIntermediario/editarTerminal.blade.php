...
@section('content')
  <div class="row">
    <div class="col-sm-8">
      {!!Form::open(array('url' => 'usuarioIntermediario/terminales/'.$terminal->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('number','latitud', $terminal->coordenadaX ,['class'=>'form-control','id'=>'latitud', 'required'])!!}
          </div>
        </div>
        <div class="form-group">
          <label for="tamanoMax" class="col-sm-2 control-label">Longitud (Grados Decimales a,a)</label>
          <div class="col-sm-10">
            {!!Form::input('number','longitud', $terminal->coordenadaY ,['class'=>'form-control','id'=>'longitud', 'required'])!!}
          </div>
        </div>
        <div class="form-group">
