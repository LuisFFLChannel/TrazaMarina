...
<table class="table table-bordered table-striped">
    ...
    <tr>
      ...
      <td class="text-center">
        <a class="btn btn-info" href="{{url('usuarioIntermediario/embarcaciones/'.$embarcacion->id.'/showCertificado')}}" title="Visualizar Certificado de Matricula" ><i class="glyphicon glyphicon-plus"></i></a>
      </td> 
      <td class="text-center">
        <a class="btn btn-info" href="{{url('usuarioIntermediario/embarcaciones/'.$embarcacion->id.'/showPermiso')}}" title="Visualizar Permiso de Pesca" ><i class="glyphicon glyphicon-plus"></i></a>
      </td> 
