...
<div class="row">
  <div class="col-sm-8">
    {!!Form::open(array('url' => 'usuarioPesca/especieMarinas/new','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('number','promedioVida', null ,['class'=>'form-control','id'=>'inputEmai3', 'min' =>0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
          <label for="tamanoMin" class="col-sm-2 control-label">Tamaño Minimo</label>
          <div class="col-sm-10">
            {!!Form::input('number','tamanoMin', null ,['class'=>'form-control','id'=>'tamanoMin', 'min' >0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
          <label for="tamanoMax" class="col-sm-2 control-label">Tamaño Maximo</label>
          <div class="col-sm-10">
            {!!Form::input('number','tamanoMax', null ,['class'=>'form-control','id'=>'tamanoMax', 'min' >0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('number','pescaPromedio', null ,['class'=>'form-control','id'=>'inputEmai3', 'min' =>0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
