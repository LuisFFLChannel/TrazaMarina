...
<table class="table table-bordered table-striped">
    ...
    <tr>
      ...
      <td class="text-center">
          <a class="btn btn-info" href="{{url('usuarioPesca/mapas/'.$pesca->id.'/mostarMapaPesca')}}" title="Mostrar Mapa" ><i class="glyphicon glyphicon-map-marker"></i></a>
        </td>
    ...
    <!-- MODAL -->
    <!--<div class="modal fade"  id="deleteModal{{$pesca->id}}">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">¿Estas seguro que desea eliminar el pesca ?</h4>
          </div>
          <div class="modal-body">
          ...
          <div class="modal-footer">
              ...
              <a class="btn btn-info" href="{{url('usuarioPesca/pescas/'.$pesca->id.'/delete')}}" title="Delete" >Sí</a>
          </div>
        </div>
      </div>
    </div>-->
