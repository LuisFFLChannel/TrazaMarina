...
@section('content')
  <div class="row">
    <div class="col-sm-8">
      {!!Form::open(array('url' => 'usuarioPesca/especieMarinas/'.$especie->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('number','factorHielo', $especie->factorHielo ,['class'=>'form-control','id'=>'inputEmai3', 'min' =>0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
