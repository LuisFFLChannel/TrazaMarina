    ...
    <div class="col-sm-8">
      {!!Form::open(array('url' => 'usuarioPesca/certificadoArribos/'.$certificadoArribo->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            {!!Form::input('date','fechaArribo', explode(" ",$certificadoArribo->fechaArribo)[0] ,['class'=>'form-control','id'=>'fechaArribo','required'])!!}
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            ...
            <a href="{{action('CertificadoArriboController@index')}}"><button type="button" class="btn btn-info">Cancelar</button></a>
          </div>
        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">¿Estas seguro que desea editar el Certificado Arribo</h4>
              </div>
