...
<table class="table table-bordered table-striped">
    ...
    <tr>
      <td class="text-center">{{$certificadoArribo->id}}</td>
      <td class="text-center">{{$certificadoArribo->nombre}}</td>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="row">
                      ...
                      <div class="col-sm-8">
                          <h5 class="text-left">N° Documento: {{$certificadoArribo->id}}</h5>
                          <h5 class="text-left">Nombre: {{$certificadoArribo->nombre}}</h5>
                          <h5 class="text-left">Toneladas Extraidas: {{$certificadoArribo->toneladas}}</h5>
      ...
      <td class="text-center">
        <a class="btn btn-info" href="{{url('usuarioPesca/certificadoArribos/'.$certificadoArribo->id.'/edit')}}" title="Editar" ><i class="glyphicon glyphicon-pencil"></i></a>
      </td> 
      <td class="text-center">
        <a class="btn btn-info" title="Eliminar" data-toggle="modal" data-target="#deleteModal{{$certificadoArribo->id}}" ><i class="glyphicon glyphicon-remove"></i></a>
      </td>
    </tr>

    <!-- MODAL -->
    <div class="modal fade"  id="deleteModal{{$certificadoArribo->id}}">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">¿Estas seguro que desea eliminar el Certificado de Arribo?</h4>
          </div>
          <div class="modal-body">
          ...
          <div class="modal-footer">
              ...
              <a class="btn btn-info" href="{{url('usuarioPesca/certificadoArribos/'.$certificadoArribo->id.'/delete')}}" title="Delete" >Sí</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
