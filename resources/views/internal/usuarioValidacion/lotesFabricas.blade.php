...
<table class="table table-bordered table-striped">
    ...
    <tr>
      ...
      <td class="text-center">
                  ...
                  <div class="modal-body">
                    <div class="row">
                      ...
                      <div class="col-sm-8">
                          ...
                          <h5 class="text-left">ID Cert. Procedencia: {{$lote->certificado_id}}</h5>
                          <h5 class="text-left">Codigo Cert. a Terminal: {{$lote->certificado->codigo}}</h5>
          ...
          <td class="text-center">
            <a class="btn btn-info" href="{{url('usuarioValidacion/lotesFabricas/'.$lote->nota->id.'/'.$lote->certificado_id.'/mostrarTrazabilidad')}}" title="Mostrar Traza" ><i class="glyphicon glyphicon-plus"></i></a>
        </td> 
    </tr>
