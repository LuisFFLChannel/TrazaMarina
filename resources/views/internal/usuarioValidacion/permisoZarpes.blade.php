...
<table class="table table-bordered table-striped">
    ...
    <tr>
      ...
      <td class="text-center">
          <a class="btn btn-info" href="{{url('usuarioValidacion/mapas/'.$permisoZarpe->pesca->id.'/mostarMapaPesca')}}" title="Mostrar Mapa" ><i class="glyphicon glyphicon-map-marker"></i></a>
        </td>
      ...
      <td class="text-center">
          ...
          <td class="text-center">
            <a class="btn btn-info" href="{{url('usuarioValidacion/permisoZarpes/'.$permisoZarpe->id.'/showPDF')}}" title="Editar" ><i class="glyphicon glyphicon-download-alt"></i></a>
          </td> 
    </tr>
