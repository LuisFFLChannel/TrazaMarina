...
<table class="table table-bordered table-striped">
    ...
    <tr>
      ...
      <td class="text-center">
          ...
          <td class="text-center">
            <a class="btn btn-info" href="{{url('usuarioValidacion/lotesTerminales/'.$lote->nota->id.'/'.$lote->transporte_id.'/mostrarTrazabilidad')}}" title="Mostrar Traza" ><i class="glyphicon glyphicon-plus"></i></a>
        </td> 
    </tr>
