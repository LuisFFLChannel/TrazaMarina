...
<table class="table table-bordered table-striped">
    ...
    <tr>
      ...
      <td class="text-center">
        <a class="btn btn-info" href="{{url('usuarioValidacion/pescadores/'.$pescador->id.'/showPermisoMarinero')}}" title="Visualizar Permiso de Marinero" ><i class="glyphicon glyphicon-plus"></i></a>
      </td> 
      <td class="text-center">
        <a class="btn btn-info" href="{{url('usuarioValidacion/pescadores/'.$pescador->id.'/showPermisoPatron')}}" title="Visualizar Permiso de Patron" ><i class="glyphicon glyphicon-plus"></i></a>
      </td> 
      <td class="text-center">
        <a class="btn btn-info" href="{{url('usuarioValidacion/pescadores/'.$pescador->id.'/validarPescador')}}" title="Validar Pescador" ><i class="glyphicon glyphicon-check"></i></a>
      </td>  
    </tr>
