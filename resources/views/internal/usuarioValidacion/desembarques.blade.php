...
<table class="table table-bordered table-striped">
    ...
    <tr>
      ...
      <td class="text-center">
        <a class="btn btn-info" href="{{url('usuarioValidacion/desembarques/'.$desembarque->id.'/showCertificado')}}" title="Visualizar Certificado de Arribo" ><i class="glyphicon glyphicon-plus"></i></a>
      </td> 
      <td class="text-center">
