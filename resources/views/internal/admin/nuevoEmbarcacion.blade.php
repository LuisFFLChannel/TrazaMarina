...
<div class="row">
  <div class="col-sm-8">
    {!!Form::open(array('url' => 'admin/embarcaciones/new','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('text','estara', null ,['class'=>'form-control','id'=>'estara', 'maxlength'=>'10','min' >0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
          <label for="manga" class="col-sm-2 control-label">Manga (metros)</label>
          <div class="col-sm-10">
            {!!Form::input('text','manga', null ,['class'=>'form-control','id'=>'manga', 'maxlength'=>'10','min' >0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
          <label for="puntual" class="col-sm-2 control-label">Puntual (metros)</label>
          <div class="col-sm-10">
            {!!Form::input('text','puntual', null ,['class'=>'form-control','id'=>'puntual', 'maxlength'=>'10','min' >0,'required'])!!}
          </div>
        </div>
