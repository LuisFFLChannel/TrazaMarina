    ...
    <div class="col-sm-8">
      {!!Form::open(array('url' => 'admin/fabricas/'.$fabrica->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('text','latitud', $fabrica->coordenadaX ,['class'=>'form-control','id'=>'latitud', 'maxlength'=>'100','min' >0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
          <label for="tamanoMax" class="col-sm-2 control-label">Longitud</label>
          <div class="col-sm-10">
            {!!Form::input('text','longitud', $fabrica->coordenadaY ,['class'=>'form-control','id'=>'longitud', 'maxlength'=>'100','min' >0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
