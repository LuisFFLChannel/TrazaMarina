...
@section('content')
        ...
        <div class="row">
          <div class="col-sm-8">
             {!!Form::open(array('url' => 'admin/usuarioIntermediario/'.$user->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
             {!!Form::hidden('id', $user->id)!!}
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                {!!Form::select('role_id', ['4' => 'Administrador', '5' => 'Usuario Pesca',  '6'=>'Usuario Intermediario', '7'=>'Validador'], $user->role_id, ['class'=>'form-control','required'])!!}
                </div>
              </div>
              <!--
              <div class="form-group">
