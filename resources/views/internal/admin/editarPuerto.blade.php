    ...
    <div class="col-sm-8">
      {!!Form::open(array('url' => 'admin/puertos/'.$puerto->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('text','nombre', $puerto->nombre ,['class'=>'form-control','id'=>'nombre', 'maxlength'=>'100','required'])!!}
          </div>
        </div>
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Direccion</label>
          <div class="col-sm-10">
            {!!Form::input('text','direccion', $puerto->direccion ,['class'=>'form-control','id'=>'direccion', 'maxlength'=>'150','required'])!!}
          </div>
        </div>
