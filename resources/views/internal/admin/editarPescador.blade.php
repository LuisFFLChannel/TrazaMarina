...
<div class="row">
  <div class="col-sm-8">
    {!!Form::open(array('url' => 'admin/pescadores/'.$pescador->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('text','dni', $pescador->dni ,['class'=>'form-control','id'=>'dni','maxlength'=>'10','min' >0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
