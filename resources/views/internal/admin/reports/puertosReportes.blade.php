...
@section('title')
    Reporte Mensual de Pesca de Puertos
@stop
...
$("#botoncito").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: url_base + "/admin/report/puertos",
        ...
        success: function(data){
            console.log(data);
            Highcharts.chart('reporte-puertos', {
                chart: {
                    type: 'line'
                },
                title: {
                    text: 'Reporte Mensual de Pesca de Puertos'
                },
                xAxis: {
