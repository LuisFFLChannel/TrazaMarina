...
@section('title')
	Lista de Usuarios de Intermediario
@stop
...
@section('content')
  ...
  <table class="table table-bordered table-striped">
      ...
      <tr>
          ...
          <td>
            <a class="btn btn-info" href="{{url('admin/usuarioIntermediario/'.$user->id.'/edit')}}" title="Editar"><i class="glyphicon glyphicon-pencil"></i></a>
            ...
            <div class="modal fade"  id="deleteModal{{$user->id}}">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">¿Estas seguro que desea eliminar el usuario de Intermediario?</h4>
                  </div>
                  <div class="modal-body">
                  ...
                  <div class="modal-footer">
                      ...
                      <a class="btn btn-info" href="{{url('admin/usuarioIntermediario/'.$user->id.'/delete')}}" title="Delete" >Sí</a>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->
