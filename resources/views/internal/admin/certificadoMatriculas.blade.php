              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Detalle del Certificado de Matricula</h4>
                  </div>
                  <div class="modal-body">
                    <div class="row">
                      <div class="col-sm-1"></div>
                      <div class="col-sm-8">
                          <h5>N° Documennto: {{$certificadoMatricula->id}}</h5>
                          <h5>Nombre Dueño: {{$certificadoMatricula->nombreDueno}} {{$certificadoMatricula->apellidosDueno}}</h5>
                          <h5>DNI Dueño: {{$certificadoMatricula->dniDueno}}</h5>
                          <h5>Numero de Matricula: {{$certificadoMatricula->nMatricula}} </h5>
                          @if($certificadoMatricula->embarcacion->nombre)
