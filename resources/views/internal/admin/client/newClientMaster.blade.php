...
@section('content')
        ...
        <div class="row">
          <div class="col-sm-8">
             {!!Form::open(array('url' => 'admin/clientMaster/new','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">¿Estas seguro que desea agregar un nuevo cliente maestro?</h4>
                    </div>
