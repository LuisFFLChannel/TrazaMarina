...
<div class="row">
  <div class="col-sm-8">
    {!!Form::open(array('url' => 'admin/pescadores/new','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('text','ubigeo', null ,['class'=>'form-control','id'=>'ubigeo', 'maxlength'=>'150','required'])!!}
          </div>
        </div>
        <div class="form-group">
