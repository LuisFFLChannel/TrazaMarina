...
<div class="row">
  <div class="col-sm-8">
    {!!Form::open(array('url' => 'admin/fabricas/new','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('text','latitud', null ,['class'=>'form-control','id'=>'latitud', 'maxlength'=>'100','min' >0,'required'])!!}
          </div>
        </div>
        <div class="form-group">
          <label for="tamanoMax" class="col-sm-2 control-label">Longitud</label>
          <div class="col-sm-10">
            {!!Form::input('text','longitud', null ,['class'=>'form-control','id'=>'longitud', 'maxlength'=>'100','min' >0,'required'])!!}
          </div>
        </div>
...
<!--
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          ...
          <a href="{{action('FabricaController@index')}}"><button type="button" class="btn btn-info">Cancelar</button></a>
        </div>
      </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">¿Estas seguro que desea crear la fabrica?</h4>
            </div>
