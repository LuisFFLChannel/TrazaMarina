...
@section('content')
  <div class="row">
    <div class="col-sm-8">
      {!!Form::open(array('url' => 'admin/capitanias/'.$capitania->id.'/edit','files'=>true,'id'=>'form','class'=>'form-horizontal'))!!}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            {!!Form::input('number','latitud', $capitania->coordenadaX ,['class'=>'form-control','id'=>'latitud', 'required'])!!}
          </div>
        </div>
        <div class="form-group">
          <label for="tamanoMax" class="col-sm-2 control-label">Longitud</label>
          <div class="col-sm-10">
            {!!Form::input('number','longitud', $capitania->coordenadaY ,['class'=>'form-control','id'=>'longitud', 'required'])!!}
          </div>
        </div>
        <div class="form-group">
